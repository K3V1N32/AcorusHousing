...
* Server staff types /region definr (address)
* Server staff establishes an address for the house/apartment
* Server staff type: /house reg (address)
...
* Player types /house givekey (address) (player name(moocher in this case))
...
* Player uses: /house takekey (address) (player)
